...
#ifndef EZSaaSCategoriesMacro_h
#define EZSaaSCategoriesMacro_h
 ...
 *******************************************************************************
 Example:
     EZSAASSYNTH_DUMMY_CLASS(NSString_EZSaaSAdd)
 */
#ifndef EZSAASSYNTH_DUMMY_CLASS
#define EZSAASSYNTH_DUMMY_CLASS(_name_) \
@interface EZSAASSYNTH_DUMMY_CLASS_ ## _name_ : NSObject @end \
@implementation EZSAASSYNTH_DUMMY_CLASS_ ## _name_ @end
#endif
