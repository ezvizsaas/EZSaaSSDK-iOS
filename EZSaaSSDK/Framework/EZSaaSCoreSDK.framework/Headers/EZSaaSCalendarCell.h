...
@class EZSaaSCalendar, EZSaaSCalendarAppearance, EZSaaSCalendarEventIndicator;

typedef NS_ENUM(NSUInteger, EZSaaSCalendarMonthPosition);

@interface EZSaaSCalendarCell : UICollectionViewCell
 ...
 */
@property (weak, nonatomic) EZSaaSCalendarEventIndicator *eventIndicator;
...
@property (weak, nonatomic) EZSaaSCalendarAppearance *appearance;

@property (strong, nonatomic) NSString *subtitle;
@property (strong, nonatomic) UIImage  *image;
@property (assign, nonatomic) EZSaaSCalendarMonthPosition monthPosition;
...
@interface EZSaaSCalendarEventIndicator : UIView
...
@interface EZSaaSCalendarBlankCell : UICollectionViewCell
