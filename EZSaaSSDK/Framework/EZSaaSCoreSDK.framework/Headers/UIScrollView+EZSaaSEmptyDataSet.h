...
//  EZSaaSEmptyDataSet
//  https://github.com/dzenbot/EZSaaSEmptyDataSet
//
//  Created by Ignacio Romero Zurbuchen on 6/20/14.
//  Copyright (c) 2016 EZSaaS Labs. All rights reserved.
//  Licence: MIT-Licence
//

#import <UIKit/UIKit.h>

@protocol EZSaaSEmptyDataSetSource;
@protocol EZSaaSEmptyDataSetDelegate;

#define EZSaaSEmptyDataSetDeprecated(instead) DEPRECATED_MSG_ATTRIBUTE(" Use " # instead " instead")

/**
 A drop-in UITableView/UICollectionView superclass category for showing empty datasets whenever the view has no content to display.
 @discussion It will work automatically, by just conforming to EZSaaSEmptyDataSetSource, and returning the data you want to show.
 */
@interface UIScrollView (EZSaaSEmptyDataSet)

/** The empty datasets data source. */
@property (nonatomic, weak) IBOutlet id <EZSaaSEmptyDataSetSource> ezsaas_emptyDataSetSource;
/** The empty datasets delegate. */
@property (nonatomic, weak) IBOutlet id <EZSaaSEmptyDataSetDelegate> ezsaas_emptyDataSetDelegate;
/** YES if any empty dataset is visible. */
@property (nonatomic, readonly, getter = ezsaas_isEmptyDataSetVisible) BOOL ezsaas_emptyDataSetVisible;
 ...
 */
- (void)ezsaas_reloadEmptyDataSet;
...
/**
 ...
 @discussion The data source must adopt the EZSaaSEmptyDataSetSource protocol. The data source is not retained. All data source methods are optional.
 */
@protocol EZSaaSEmptyDataSetSource <NSObject>
@optional
 ...
 */
- (CGPoint)offsetForEmptyDataSet:(UIScrollView *)scrollView EZSaaSEmptyDataSetDeprecated(-verticalOffsetForEmptyDataSet:);
...
/**
 ...
 @discussion The delegate can adopt the EZSaaSEmptyDataSetDelegate protocol. The delegate is not retained. All delegate methods are optional.
 
 @discussion All delegate methods are optional. Use this delegate for receiving action callbacks.
 */
@protocol EZSaaSEmptyDataSetDelegate <NSObject>
@optional
 ...
 */
- (void)emptyDataSetDidTapView:(UIScrollView *)scrollView EZSaaSEmptyDataSetDeprecated(-emptyDataSet:didTapView:);
...
/**
 ...
 @param scrollView A scrollView subclass informing the delegate.
 */
- (void)emptyDataSetDidTapButton:(UIScrollView *)scrollView EZSaaSEmptyDataSetDeprecated(-emptyDataSet:didTapButton:);
...
#undef EZSaaSEmptyDataSetDeprecated
