//
//  UIGestureRecognizer+EZSaaSAdd.h
 ...
 */
@interface UIGestureRecognizer (EZSaaSAdd)
 ...
 */
- (instancetype)initWithEZSaaS_ActionBlock:(void (^)(id sender))block;
 ...
 */
- (void)ezsaas_addActionBlock:(void (^)(id sender))block;

/**
 Remove all action blocks.
 */
- (void)ezsaas_removeAllActionBlocks;
