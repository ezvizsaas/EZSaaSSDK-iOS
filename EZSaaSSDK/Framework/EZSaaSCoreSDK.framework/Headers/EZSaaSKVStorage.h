 ...
 */
@interface EZSaaSKVStorageItem : NSObject
 ...
 */
typedef NS_ENUM(NSUInteger, EZSaaSKVStorageType) {
    
    /// The `value` is stored as a file in file system.
    EZSaaSKVStorageTypeFile = 0,
    
    /// The `value` is stored in sqlite with blob type.
    EZSaaSKVStorageTypeSQLite = 1,
    
    /// The `value` is stored in file system or sqlite based on your choice.
    EZSaaSKVStorageTypeMixed = 2,
};
 ...
 */
@interface EZSaaSKVStorage : NSObject
...
@property (nonatomic, readonly) EZSaaSKVStorageType type;  ///< The type of this storage.
 ...
 */
- (nullable instancetype)initWithPath:(NSString *)path type:(EZSaaSKVStorageType)type NS_DESIGNATED_INITIALIZER;
 ...
 */
- (BOOL)saveItem:(EZSaaSKVStorageItem *)item;
 ...
 */
- (nullable EZSaaSKVStorageItem *)getItemForKey:(NSString *)key;
 ...
 */
- (nullable EZSaaSKVStorageItem *)getItemInfoForKey:(NSString *)key;
 ...
 */
- (nullable NSArray<EZSaaSKVStorageItem *> *)getItemForKeys:(NSArray<NSString *> *)keys;
...
/**
 ...
 @return An array of `YYKVStorageItem`, or nil if not exists / error occurs.
 */
- (nullable NSArray<EZSaaSKVStorageItem *> *)getItemInfoForKeys:(NSArray<NSString *> *)keys;
