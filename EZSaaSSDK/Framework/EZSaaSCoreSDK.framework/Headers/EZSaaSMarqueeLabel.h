...
typedef NS_ENUM(NSUInteger, EZSaaSMarqueeType) {
...
IB_DESIGNABLE
@interface EZSaaSMarqueeLabel : UILabel <CAAnimationDelegate>
...
#else
@property (nonatomic, assign) EZSaaSMarqueeType marqueeType;
#endif
